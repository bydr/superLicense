                        ...
                        <div class="w-100 max-w-820">
                            ...
                            <div class="form-group form-group_row ml-0" style="max-width: 420px;">
                                <label for="id-number-people" class="label form-group__label">
                                    <span>Кол-во работающих</span><span class="dr-text__small">(в кабинете, косметологии, мед. центре и т. д.)</span>
                                </label>
                            ...
                            <div class="form-group form-group_row ml-0">
                                <label for="id-number-people2" class="label form-group__label">
                                    ...
                                    <span class="tooltip-btn tooltip-btn__circle"
                                          ...
                                          data-html="true"
                                          data-placement="top"
                                          data-content="К декретированным контингентам относятся работники, занятые на работах, установленных перечнем приложения №2 к приказу Министерства здравоохранения № 302н от 12.04.2011. <br><br>Для аптеки и фармсклада - работники занятые реализацией парфюмерно-косметических средств, средств гигиены полости рта, минеральной воды, биологически активных добавок к пище, иммунобиологических препаратов (вакцин). <br><br>Для аптек производственных - работники, занятые приготовлением средств по рецепту врача. <br><br>Для ветаптеки - работники занятые реализацией парфюмерно-косметических средств, средств гигиены, воды, кормов, антибиотиков, антигельминстных препаратов, игрушек биологически активных добавок к пище. <br><br>Для оптики - работники, занятые реализацией очков, линз, средств гигиены.">
                                        <span class="icon">
